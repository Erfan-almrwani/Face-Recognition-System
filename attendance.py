...
class Attendance:
    ...
    def __init__(self,root):
        ...
        bg1=bg1.resize((2000,1500),Image.Resampling.LANCZOS)
        self.photobg1=ImageTk.PhotoImage(bg1)

        # set image as lable
        bg_img = Label(self.root,image=self.photobg1)
        bg_img.place(x=0,y=0,width=2000,height=1500)
        ...
        # Left Label Frame 
        left_frame = LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Pesrson Details",font=("verdana",12,"bold"),fg="navyblue")
        ...
        #Student id
        personId_label = Label(left_frame,text="Per-ID:",font=("verdana",12,"bold"),fg="navyblue",bg="white")
        personId_label.grid(row=0,column=0,padx=5,pady=5,sticky=W)
        personId_entry = ttk.Entry(left_frame,textvariable=self.var_id,width=15,font=("verdana",12,"bold"))
        personId_entry.grid(row=0,column=1,padx=5,pady=5,sticky=W)
        #persont Roll
        person_roll_label = Label(left_frame,text="N.I.D:",font=("verdana",12,"bold"),fg="navyblue",bg="white")
        person_roll_label.grid(row=0,column=2,padx=5,pady=5,sticky=W)
        person_roll_entry = ttk.Entry(left_frame,textvariable=self.var_roll,width=15,font=("verdana",12,"bold"))
        person_roll_entry.grid(row=0,column=3,padx=5,pady=5,sticky=W)
        #persont Name
        person_name_label = Label(left_frame,text="Per-Name:",font=("verdana",12,"bold"),fg="navyblue",bg="white")
        person_name_label.grid(row=1,column=0,padx=5,pady=5,sticky=W)
        person_name_entry = ttk.Entry(left_frame,textvariable=self.var_name,width=15,font=("verdana",12,"bold"))
        person_name_entry.grid(row=1,column=1,padx=5,pady=5,sticky=W)
        ...
        self.attendanceReport_left.heading("ID",text="Per-ID")
        self.attendanceReport_left.heading("Roll_No",text="N.I.D")
        self.attendanceReport_left.heading("Name",text="Per-Name")
        ...
        self.attendanceReport.heading("ID",text="Per-ID")
        self.attendanceReport.heading("Roll_No",text="N.I.D")
        self.attendanceReport.heading("Name",text="Per-Name")
