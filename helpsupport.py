...
# This part is image labels setting start 
        # first header image  
        # img=Image.open(r"E:\courses\project paython\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\banner1.jpg")
        # img=img.resize((1366,130),Image.Resampling.LANCZOS)
        # self.photoimg=ImageTk.PhotoImage(img)

        # # set image as lable
        # f_lb1 = Label(self.root,image=self.photoimg)
        # f_lb1.place(x=0,y=0,width=1366,height=900)

        # backgorund image 
        bg1=Image.open(r"E:\courses\project paython\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\banner1.jpg")
        bg1=bg1.resize((1900,1000),Image.Resampling.LANCZOS)
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn=Image.open(r"E:\courses\project paython\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\web.png")
        ...
        std_b1.place(x=250,y=300,width=180,height=180)
        ...
        det_img_btn=Image.open(r"E:\courses\project paython\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\fb.png")
        ...
        det_b1.place(x=510,y=300,width=180,height=180)

        det_b1_1 = Button(bg_img,command=self.facebook,text="Facebook",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="black")
        det_b1_1.place(x=510,y=480,width=180,height=45)

         # Attendance System  button 3
        att_img_btn=Image.open(r"E:\courses\project paython\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\yt.png")
        ...
        att_b1.place(x=760,y=300,width=180,height=180)

        att_b1_1 = Button(bg_img,command=self.youtube,text="Youtube",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="black")
        att_b1_1.place(x=760,y=480,width=180,height=45)

         # Help  Support  button 4
        hlp_img_btn=Image.open(r"E:\courses\project paython\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\gmail.png")
